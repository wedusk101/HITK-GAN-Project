...
class GAN:
    ...
    def train_digit(self, mnist, digit, path):
        ...
        for step in range(20000):
            ...
            if step % 250 == 0: # writing the image file to disk
    ...
    def build_generator(self): # Works like a de-convolutional network so to speak. Note the reverse order of the layers compared to the discrimator below
